...
class Agent(object):
    ...
    def save_models(self):
        self.q_eval.save('MODELS/' + self.q_eval_model_file)
        self.q_next.save('MODELS/' + self.q_target_model_file)
        # print('... saving models ...')

    def load_models(self):
        self.q_eval = load_model('MODELS/' + self.q_eval_model_file)
        self.q_nexdt = load_model('MODELS/' + self.q_target_model_file)
