...
n_steps = 400000 # total number of training steps
...
copy_steps = 1000 # copy the critic to the actor every 25 training steps
discount_rate = 0.95
...
with tf.Session() as sess:
	...
	while True:
		...
		# print("\nIteration: {}, Steps: {}, eps: {:.3f}".format(iteration, step, discount_rate), end="")
